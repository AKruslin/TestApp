    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `commentDB` (`postId` INTEGER NOT NULL, `id` INTEGER NOT NULL, `name` TEXT NOT NULL, `email` TEXT NOT NULL, `body` TEXT NOT NULL, PRIMARY KEY (`id`))');
...
class _$CommentDao extends CommentDao {
  ...
  @override
  Future<List<Comment>> findAllPersons() async {
    return _queryAdapter.queryList('SELECT * FROM commentDB',
